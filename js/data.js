...
const qnaList = [
  {
    q: "1. 나의 여/남친이 여/남사친과 단 둘이 술을 마신다고 한다.",
    a: [
      { answer: "a. 거기가면 나랑 헤어지는거야", type: ["1", "2", "4", "9"] },
      {
        answer: "b. 그래, 대신 연락잘해 / 집 갈 때 연락해",
        type: ["0", "3", "6", "5", "10", "8"],
      },
  ...
  {
    q: "2. 좋아하는 이성이 생겨 연락하고자 한다 ",
    a: [
      { answer: "a. 일단 연락하고 본다.", type: ["0", "3", "2", "8"] },
      {
  ...
  },
  {
    ...
    a: [
      { answer: "a. 야 나랑 사귀자 ", type: ["1", "2", "4"] },
      {
        answer: "b. 나 너 많이 좋아해, 나랑 사귈래? ",
        type: ["7", "10", "8", "9", "11"],
      },
      {
        answer: "c. 우리 내일은 연인으로 만날까요? ",
        type: ["0", "3", "6", "5"],
      },
    ],
  },
  {
    ...
    a: [
      ...
      {
        answer: "b. 가벼운 뽀뽀까지 가능하지",
        type: ["0", "3", "6", "11"],
      },
      {
        answer: "c. 범위? 그게 뭐야? 다 해버려",
        type: ["2", "5", "8"],
      },
    ],
  },

  {
    ...
    a: [
      ...
      {
        answer: "b. 맛있는 밥과 선물사면 되겠지?",
        type: ["0", "3", "6", "10"],
      },
      {
        answer: "c. 데이트 코스, 이벤트, 상대가 필요할 것 같은 선물 준비",
        type: ["1", "7", "2", "5", "8"],
      },
    ],
  },
  {
    ...
    a: [
      ...
      {
        answer: "b. 눈치는 채나 말은 꺼내지 않고 은근히 칭찬한다.",
        type: ["2", "4", "9"],
      },
      {
        answer:
          'c. "오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 티낸다.',
        type: ["0", "3", "6", "5", "10", "8"],
      },
    ],
  },
  ...
  },
  {
    ...
    a: [
      {
        answer: "a. 화가 풀릴 때까지 시간을 둔다.",
        type: ["3", "6", "4", "9"],
      },
      {
        answer: "b. 어떤점이 문제인지 그 자리에서 푼다.",
        type: ["0", "2", "5", "10", "8"],
      },
      {
        answer: "c. 조용히 운다.",
